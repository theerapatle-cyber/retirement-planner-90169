            ...
            <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                            <div className="w-24 h-24 rounded-full border-4 border-white shadow-lg overflow-hidden bg-slate-100 flex items-center justify-center">
                                {avatar ? (
                                    ...
                                    <span className="text-3xl font-bold text-slate-300">{name.charAt(0).toUpperCase()}</span>
                                )}
                            </div>
                        ...
                        <p className="text-xs text-slate-400">Click to change profile picture</p>
                    </div>
                    ...
                    <Button onClick={handleSave} className="w-full h-12 rounded-xl text-lg gap-2 bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200">
                        <Save size={20} />
                        Save Changes
                    </Button>
                </div>
